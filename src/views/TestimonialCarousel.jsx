  ...
  return (
    <div className="max-w-6xl mx-auto pb-10 mb-5 ">
      <div className="max-w-6xl mx-auto p-2 mt-0">
        <div>
          <h3 className="text-3xl  md:text-4xl lg:text-5xl  mb-6 font-medium text-fontBlack text-center">
            Customer Review
          </h3>
          <h6 className="text-xl md:text-2xl lg:text-2xl text-fontBlack mb-6 text-center">
        ...
        <Slider {...settings}>
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="bg-white p-10 md:p-10 lg:p-15 rounded-lg shadow-lg"
            >
              ...
              <p className="text-gray-800 p-2 md:p-10 lg:p-15 text-[15px]  md:text-xl lg:text-xl mb-4 md:mb-2 lg:mb-2 text-center">
                {testimonial.comment}
              </p>
              <p className="text-gray-600 mt-4 md:mt-0 lg:mt-0 font-semibold text-center">
                {testimonial.name}
              </p>
            </div>
          ))}
